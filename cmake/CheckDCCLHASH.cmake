...
if (NOT OUTPUT_HASH STREQUAL EXPECTED_HASH)
  message(FATAL_ERROR "DCCL hash mismatch for message ${DCCL_NAME}! Expected: ${EXPECTED_HASH}, Got: ${OUTPUT_HASH}. Please update PROJECT_INTERVEHICLE_API_VERSION in jaiabot/cmake/JaiaVersions.cmake and expected hash in jaiabot/src/lib/messages/CMakeLists.txt. (Debug: Error: ${ERROR}; Result: ${RESULT}")
endif()
