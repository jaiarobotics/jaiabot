...
if [ -z "$1" ]
    then
	    ...
	    do
		    ...
		    rsync -zaP --delete --force --relative ./src/python ./build/arm64/bin ./build/arm64/lib ./build/arm64/include ./config ./scripts ./src/arduino ubuntu@"$var":/home/ubuntu/jaiabot/
	    done
fi
