    ...
    for filename in file_list:
        with h5py.File(filename, 'r') as file:
            ...
            try:
                ...
                instances = pd.concat([bot_id[start_idx:end_idx], status_pitch[start_idx:end_idx], status_yaw[start_idx:end_idx], bot_lat[start_idx:end_idx], bot_long[start_idx:end_idx], status_depth[start_idx:end_idx], mission_state[start_idx:end_idx], status_datetime[start_idx:end_idx]], axis=1)
