...
echo -e "deb http://packages.jaia.tech/ubuntu/continuous/1.y/ focal/\ndeb http://packages.jaia.tech/ubuntu/gobysoft/continuous/1.y/ focal/" >> /etc/apt/sources.list.d/jaiabot_release_1.y.list && \
