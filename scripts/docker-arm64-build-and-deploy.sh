...
then
    ...
    do
        ...
        rsync -zav --progress --force --relative --delete --exclude node_modules/ --exclude venv/ ./${build_dir}/bin ./${build_dir}/include ./${build_dir}/share/ ./${build_dir}/lib ./src/web/jcc.conf ./config ./scripts -e "ssh -i /home/michaelrock/.ssh/master_yubikey19377734" ${botuser}@"$remote":/home/${botuser}/jaiabot/
