...
{ 'gobyd':                                        { 'runtime': { 'tty': 'WARN', 'log': 'WARN'  }, 'simulation': { 'tty': 'WARN', 'log': 'WARN' }},
  ...
  'jaiabot_state_estimator':                      { 'runtime': { 'tty': 'WARN', 'log': 'WARN' },  'simulation': { 'tty': 'WARN', 'log': 'QUIET' }},
}
...
if common.app == 'gobyd':    
    ...
    print(config.template_substitute(templates_dir+'/bot/jaiabot_sensors.pb.cfg.in',
                                     ...
                                     baud=115200,
                                     fluorometer_coefficients=fluorometer_coefficients))
elif common.app == 'jaiabot_state_estimator':
    print(config.template_substitute(templates_dir+'/bot/jaiabot_state_estimator.pb.cfg.in',
                                     app_block=app_common,
                                     interprocess_block=interprocess_common))
