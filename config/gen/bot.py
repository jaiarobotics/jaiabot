...
jaia_trinket_harness_info_type="NONE"

if "jaia_trinket_harness_info_type" in os.environ:
    jaia_trinket_harness_info_type=os.environ['jaia_trinket_harness_info_type']
...
if common.app == 'gobyd':    
    ...
    print(config.template_substitute(templates_dir+'/bot/jaiabot_health.pb.cfg.in',
                                     app_block=app_common,
                                     interprocess_block = interprocess_common,
                                     bind_port=common.udp.trinket_cpp_udp_port(),
                                     remote_port=common.udp.trinket_py_udp_port(),
