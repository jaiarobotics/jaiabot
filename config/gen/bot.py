...
{ 'gobyd':                                        { 'runtime': { 'tty': 'WARN', 'log': 'DEBUG1' }, 'simulation': { 'tty': 'WARN', 'log': 'QUIET' }},
  ...
  'jaiabot_atlas_scientific_ezo_ec_driver':       { 'runtime': { 'tty': 'WARN', 'log': 'DEBUG2' }, 'simulation': { 'tty': 'DEBUG2', 'log': 'DEBUG2' }},
  'jaiabot_adafruit_BNO055_driver':               { 'runtime': { 'tty': 'WARN', 'log': 'DEBUG2' }, 'simulation': { 'tty': 'DEBUG2', 'log': 'DEBUG2' }},
