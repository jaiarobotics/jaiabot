...
jaiabot_apps = [
    ...
    {'exe': 'jaiabot_state_estimator',
     ...
     'template': 'goby-app.service.in',
     # Generic code on purpose: Error is a DCCL field of BotStatus, so a new enumerator changes
     # the wire hash and needs every bot and hub updated in lockstep. Add a dedicated code and
     # bump PROJECT_INTERVEHICLE_API_VERSION when this leaves evaluation.
