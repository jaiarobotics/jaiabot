...
jaiabot_apps = [
    ...
    {'exe': 'gpsd',
     ...
     'runs_on': Type.BOT,
     'runs_when': Mode.SIMULATION},
    {'exe': 'jaiabot_motor_sensor_driver',
     'description': 'JaiaBot Motor Driver',
     'template': 'goby-app.service.in',
     'error_on_fail': 'ERROR__FAILED__JAIABOT_MOTOR_SENSOR_DRIVER',
     'runs_on': Type.BOT,
     'wanted_by': 'jaiabot_health.service'},
    {'exe': 'rpm.py',
     ...
     'subdir': 'motor',
     'args': '',
     'error_on_fail': 'ERROR__FAILED__PYTHON_JAIABOT_MOTOR_SENSOR_DRIVER',
     'runs_on': Type.BOT,
     'runs_when': Mode.RUNTIME,
     'wanted_by': 'jaiabot_health.service',
     'restart': 'on-failure'},
