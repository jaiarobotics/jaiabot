...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  */
    ...
    PC4     ------> ADC1_IN13
    */
    GPIO_InitStruct.Pin = VCC_V_SENSE_Pin|VCC_CURR_SENSE_Pin|SYS_CURR_SENSE_Pin|EXT_AN_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG_ADC_CONTROL;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = VCC_MID_SENSE_Pin|THERMISTOR_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG_ADC_CONTROL;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  if(hadc->Instance==ADC1)
  {
    ...
    PC4     ------> ADC1_IN13
    */
    HAL_GPIO_DeInit(GPIOC, VCC_V_SENSE_Pin|VCC_CURR_SENSE_Pin|SYS_CURR_SENSE_Pin|EXT_AN_Pin);

    HAL_GPIO_DeInit(GPIOA, VCC_MID_SENSE_Pin|THERMISTOR_Pin);
...
void HAL_LPTIM_MspInit(LPTIM_HandleTypeDef* hlptim)
{
  ...
  */
       ...
       Kept in USER CODE so CubeMX regen doesn't revert it. */
    {
      ...
      LptimClkInit.Lptim1ClockSelection = RCC_LPTIM1CLKSOURCE_LSI;
      if (HAL_RCCEx_PeriphCLKConfig(&LptimClkInit) != HAL_OK)
      {
        Error_Handler();
      }
    }
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* htim)
{
  ...
  if(htim->Instance==TIM2)
  {
    ...
    PA15 (JTDI)     ------> TIM2_CH1
    */
    GPIO_InitStruct.Pin = EXT_5V_PWM_Pin|EXT_12V_PWM_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    ...
    GPIO_InitStruct.Pin = EXT_LED_PWM_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF1_TIM2;
    HAL_GPIO_Init(EXT_LED_PWM_GPIO_Port, &GPIO_InitStruct);
