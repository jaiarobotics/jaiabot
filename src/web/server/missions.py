...
def create_mission_plan(deploy_lat, deploy_lon, boundary_points, mission_type, spacing_meters, orientation, bot_list):
    ...
    if spacing_meters and spacing_meters > 0:
        ...
        # Random distribution of 40 goals within the survey polygon
        points = MultiPoint(distribute_num_points(p, number_of_bots * 40))
...
def assign_points_to_bots(survey_points, bot_list):
    ...
    """
    number_of_bots = len(bot_list)
    # TODO: Only allow 40 points per bot, change to setting somewhere if goals maximum of 40 is changed
    survey_points_restricted = survey_points[0:number_of_bots*40]
