...
// Utilities
import { validateNumInput } from "../../../shared/Utilities";
...
export default function ContactInfoPanel(props: Props) {
    ...
    const handleTrailClick = () => {
        ...
        const botMission = Missions.TrailMode(
            botAssigned,
        ...
        CustomAlert.confirm(
            `Are you sure you'd like bot: ` +
                botAssigned?.toString() +
                ` to trail contact: ` +
                props.contact?.contact?.toString(),
            ...
            <div className="contact-info-layout-container">
                ...
                <div className="contact-info-outer-container">
                    ...
                    <div className="contact-info-panel-container">
                        ...
                        <Box sx={{ minWidth: 120 }}>
                            <FormControl fullWidth>
                                ...
                                >
                                    ...
                                    {props.botIds.map((id) => {
                                        return (
                                            <MenuItem key={id} value={id}>{`Bot-${id}`}</MenuItem>
                                        );
                                    })}
                                </Select>
                            </FormControl>
                        ...
                        <div className="contact-info-line-break"></div>
                        <button className="contact-info-btn" onClick={() => handleTrailClick()}>
                            Trail Contact
                        </button>
                    </div>
                </div>
