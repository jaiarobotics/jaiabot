...
/**
 * Produces the dialog box that appears when clicking on the export mission set button.
 * This dialog will be an alert if the mission set cannot be exported
 */
export function ExportMissionSetDialog(props: DialogProps) {
    /**
