...
run_request({"target": {"all": True}, "command_for_hub": {"type": "SET_HUB_LOCATION", "hub_location": { "lat": 41.7 }}},
            expected_response_subset={"error": {"code": "API_ERROR__REQUEST_NOT_INITIALIZED"}})


run_request({"target": {"bots": [1]}, "metadata": True},
...
run_request({"target": {"bots": [1]}, "task_packets": {"start_time": now_micros - 28 * DAY, "end_time": now_micros + DAY}},
