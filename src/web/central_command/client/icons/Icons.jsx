...
import startUnselected from "../icons/start-unselected.svg"
export {startUnselected}
export const startUnselectedStyle = new OlStyle({ image: new OlIcon({ src: startUnselected }) })

import startSelected from "../icons/start-selected.svg"
...
import waypointSelected from "../icons/waypoint-selected.svg"
...
export {botSelected}
export const botSelectedStyle = new OlStyle({ image: new OlIcon({ src: botSelected }) })

import botUnselected from "../icons/bot-unselected.svg"
export {botUnselected}
export const botUnselectedStyle = new OlStyle({ image: new OlIcon({ src: botUnselected }) })
