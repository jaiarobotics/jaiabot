...
export class JaiaAPI {
    ...
    allStop() {
        return this.post('jaia/allStop')
    }

    allActivate() {
        return this.post('jaia/allActivate', null)
    }

    nextTaskAll() {
        return this.post('jaia/nextTaskAll', null)
    }

    allRecover() {
        return this.post('jaia/allRecover', null)
    }
    ...
    postCommandForHub(command: CommandForHub) {
        return this.post('jaia/commandForHub', command)
    }
    ...
    takeControl() {
        return this.post('jaia/takeControl', null)
    }
    ...
    getContourMapBounds() {
        return this.get('jaia/contour-bounds')
    }
}
