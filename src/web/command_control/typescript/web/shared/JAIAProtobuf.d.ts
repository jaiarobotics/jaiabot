...
export declare enum OptimizeMode {
    SPEED = "SPEED",
    CODE_SIZE = "CODE_SIZE",
...
export declare enum LeapIndicator {
...
export declare enum NTPSystemEvent {
...
export declare enum MissionStart {
...
export declare enum DensityAlgorithm {
...
export declare enum SetpointType {
...
export declare enum IMUCommandType {
...
export declare enum HubCommandType {
...
export declare enum BotStatusRate {
