                    ...
                    <div>
                        <table className="MissionParametersTable">
                            ...
                            <tr>
                                ...
                                <td><input id='missionOrientation' className="NumberInput" name="orientation" defaultValue={this.state.mission_params.orientation} onChange={this.changeMissionParameter.bind(this)} /> deg</td>
                            </tr>
                            <tr hidden>
