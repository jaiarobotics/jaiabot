...
struct ParachuteAttachmentRecovery;
#else
struct ParachuteAttachmentRecovery
    : boost::statechart::state<ParachuteAttachmentRecovery, SelfTest>,
      Notify<ParachuteAttachmentRecovery, protobuf::SELF_TEST__PARACHUTE_ATTACHMENT_RECOVERY>
{
