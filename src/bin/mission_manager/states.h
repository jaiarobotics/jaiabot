                                ...
                                Notify<Derived, state, protobuf::SETPOINT_STOP>
{
    ...
    SurfaceDriftTaskCommon(typename StateBase::my_context c) : StateBase(c)
    {
        ...
        auto imu_command = jaiabot::protobuf::IMUCommand();
        imu_command.set_type(jaiabot::protobuf::IMUCommand::START_WAVE_HEIGHT_SAMPLING);
        ...
        if (start_echo_sensor)
        {
            ...
            auto echo_command = jaiabot::protobuf::EchoCommand();
            echo_command.set_type(jaiabot::protobuf::EchoCommand::CMD_START);
    ...
    ~SurfaceDriftTaskCommon()
    {
            ...
            drift_packet().has_drift_duration() && drift_packet().drift_duration() > 0)
        {
            ...
            auto imu_command = jaiabot::protobuf::IMUCommand();
            imu_command.set_type(jaiabot::protobuf::IMUCommand::STOP_WAVE_HEIGHT_SAMPLING);
            this->interprocess().template publish<jaiabot::groups::imu>(imu_command);
            ...
            if (stop_echo_sensor)
            {
                // Stop echo recording
                auto echo_command = jaiabot::protobuf::EchoCommand();
                echo_command.set_type(jaiabot::protobuf::EchoCommand::CMD_STOP);
                this->interprocess().template publish<jaiabot::groups::echo>(echo_command);
            }
        }
    }
