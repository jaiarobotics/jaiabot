...
jaiabot::apps::ArduinoStatusThread::ArduinoStatusThread(
    ...
    : HealthMonitorThread(cfg, "arduino_status", 30.0 / 60.0 * boost::units::si::hertz)
{
    interprocess().subscribe<jaiabot::groups::arduino>(
        [this](const jaiabot::protobuf::ArduinoResponse& arduino_response) {
            ...
            status_.set_thermocouple_temperature_c(arduino_response.thermocouple_temperature_c());
