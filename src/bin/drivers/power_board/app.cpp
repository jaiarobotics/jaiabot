...
// raw IO Data
constexpr goby::middleware::Group power_board_serial_in{
    "jaiabot::power_board::power_board_serial_in"};
constexpr goby::middleware::Group power_board_serial_out{
    "jaiabot::power_board::power_board_serial_out"};
...
void jaiabot::apps::PowerBoard::receive_from_mcu(const goby::middleware::protobuf::IOData& io_msg)
{
    ...
    try
    {
        ...
        glog.is_verbose() &&
            glog << "Received data from MCU: " << power_board_msg.ShortDebugString() << std::endl;
    ...
    const jaiabot::protobuf::Metadata& metadata)
{
    ...
    {
        glog.is_verbose() &&
            glog << "Power Board Software Version: " << metadata.power_board_version() << std::endl;
    }
}
...
void jaiabot::apps::PowerBoard::handle_control_surfaces(
    const jaiabot::protobuf::ControlSurfaces& control_surfaces)
{
    jaiabot::protobuf::PowerBoardRequest request;
    request.set_time_with_units(goby::time::SystemClock::now<goby::time::MicroTime>());
