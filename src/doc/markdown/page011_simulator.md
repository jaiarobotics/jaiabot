...
The `jaiabot` simulator (`jaiabot_simulator`) is intended to provide a full system simulation capable of faster-than-realtime simulation of the relavant software components.
...
The following figures are autogenerated using `goby_clang_tool` from the `src/doc/deployment/simulation_deployment.yml` deployment file.
