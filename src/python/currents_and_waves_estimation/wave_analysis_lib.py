...
MIN_STATION_KEEP_LENGTH_M = 1/60 # TODO: Change back to a reasonable amount of time (default was 1.5 mins). Min drift length for Surob mission plan is 2 minutes, give some margin for clipped ends
