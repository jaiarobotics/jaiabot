...
from jaiabot.messages import echo_pb2 as jaiabot_dot_messages_dot_echo__pb2
...
_ECHO = _descriptor.Descriptor(
  name='Echo',
  full_name='jaiabot.protobuf.Echo',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='start_echo', full_name='jaiabot.protobuf.Echo.start_echo', index=0,
      number=1, type=8, cpp_type=7, label=1,
      has_default_value=True, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='stop_echo', full_name='jaiabot.protobuf.Echo.stop_echo', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='echo_state', full_name='jaiabot.protobuf.Echo.echo_state', index=2,
...
_ENGINEERING = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='echo', full_name='jaiabot.protobuf.Engineering.echo', index=11,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='flag', full_name='jaiabot.protobuf.Engineering.flag', index=12,
    ...
    _descriptor.FieldDescriptor(
      name='bounds', full_name='jaiabot.protobuf.Engineering.bounds', index=13,
...
_ECHO.fields_by_name['echo_state'].enum_type = jaiabot_dot_messages_dot_echo__pb2._ECHOSTATE
...
_ENGINEERING.fields_by_name['bottom_depth_safety_params'].message_type = jaiabot_dot_messages_dot_mission__pb2._BOTTOMDEPTHSAFETYPARAMS
_ENGINEERING.fields_by_name['imu_cal'].message_type = _IMUCALIBRATION
_ENGINEERING.fields_by_name['echo'].message_type = _ECHO
...
Echo = _reflection.GeneratedProtocolMessageType('Echo', (_message.Message,), dict(
  DESCRIPTOR = _ECHO,
  __module__ = 'jaiabot.messages.engineering_pb2'
  # @@protoc_insertion_point(class_scope:jaiabot.protobuf.Echo)
  ))
