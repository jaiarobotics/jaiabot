...
jaiabot::LiaisonJaiabot::VehicleData::Controls::Controls(Wt::WContainerWidget* vehicle_div,
    ...
    : controls_box(new WGroupBox("Low Level Controls ('R' resets to center values)", vehicle_div)),
        ...
        fins_box(new WGroupBox("Fins", controls_box)),
                port_box_top(new WContainerWidget(fins_box)),
                    port_elevator_top_text(new WText(cfg.elevator_bounds().max_label(), port_box_top)),
                port_box_middle(new WContainerWidget(fins_box)),
                    port_elevator_slider(new WSlider(Vertical, port_box_middle)),
                port_box_bottom(new WContainerWidget(fins_box)),
                    port_elevator_bottom_text(new WText(cfg.elevator_bounds().min_label(), port_box_middle)),
                ...
                stbd_box_top(new WContainerWidget(fins_box)),
                    stbd_elevator_top_text(new WText(cfg.elevator_bounds().max_label(), stbd_box_top)),
                stbd_box_middle(new WContainerWidget(fins_box)),
                    stbd_elevator_slider(new WSlider(Vertical, stbd_box_middle)),
                stbd_box_bottom(new WContainerWidget(fins_box)),
                    stbd_elevator_bottom_text(new WText(cfg.elevator_bounds().min_label(), stbd_box_bottom)),
